...
public class CreateContact {
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@id='firstNameField']")).sendKeys("Bhargavi");
		driver.findElement(By.xpath("//input[@id='lastNameField']")).sendKeys("Srinivas");
		driver.findElement(By.xpath("//input[@id='createContactForm_firstNameLocal']")).sendKeys("Appa");
		driver.findElement(By.xpath("//input[@id='createContactForm_lastNameLocal']")).sendKeys("Srinu");
		...
		driver.findElement(By.xpath("//input[@id='createContactForm_primaryEmail']")).sendKeys("srinivasbhargavi5@gmail.com");
